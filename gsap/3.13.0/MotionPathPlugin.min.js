...
!(function (t, e) {
  ...
  function getPositionOnPath(t, e, n, r) {
    ...
    if (
      ((e < 0 || 1 < e) && (e = d(e)),
      p.lookup || cacheRawPathMeasurements(t),
      1 < t.length)
    ) {
    ...
    for (e = 0; e < x; e++)
      if (
        ...
        (u = y),
          (g = w),
          ("C" !== p && "S" !== p) ||
            ((u += y - s[s.length - 4]), (g += w - s[s.length - 3])),
          i || (y = w = 0),
          s.push(u, g, r, a, (y += 1 * m[e + 3]), (w += 1 * m[e + 4])),
          (e += 4);
      else if ("Q" === o)
        (u = y + (2 / 3) * (r - y)),
          (g = w + (2 / 3) * (a - w)),
          ...
          (y += 1 * m[e + 3]),
          (w += 1 * m[e + 4]),
          s.push(u, g, y + (2 / 3) * (r - y), w + (2 / 3) * (a - w), y, w),
          (e += 4);
      else if ("T" === o)
        (u = y - s[s.length - 4]),
          (g = w - s[s.length - 3]),
          ...
          (d =
            ...
            ((p = y - (y - r) * (s ? h / s : 0)) +
              ((((c = y + (x - y) * (l ? h / l : 0)) - p) *
                ...
                4 || 0))),
          (v === n && y === r) ||
            P.push(N(u + f), N(p + d), N(v), N(y), N(g + f), N(c + d)));
    return (
      v !== w || y !== x || P.length < 4
        ? P.push(N(w), N(x), N(w), N(x))
        : (P.length -= 2),
      2 === P.length
        ? P.push(v, y, v, y, v, y)
  ...
  var Q,
    ...
    a = {
      ...
      register: function register(t, e, n) {
        (W = (Q = t).utils.getUnit),
          (J = Q.utils.toArray),
          (K = Q.core.getStyleSaver),
          (o = Q.core.reverting || function () {}),
          (g = n);
      },
      init: function init(t, e, n) {
        ...
        if (
          ...
          for (a in f)
            !u && ~tt.indexOf(a) ? (u = a) : !g && ~et.indexOf(a) && (g = a);
          for (a in (u && g
            ? o.push(
                qa(
                  this,
          ...
          f))
            a !== u &&
              a !== g &&
              o.push(qa(this, na([], i, a, 2), t, a, 0, p, e, W(i[0][a])));
        }
